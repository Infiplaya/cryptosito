      ...
      {paginationRange!.map((pageNumber) => {
        ...
        if (pageNumber === DOTS) {
          return (
            <li
              key={pageNumber}
              className="flex items-center px-3 py-2 leading-tight text-lg"
            >
              &#8230;
            </li>
          );
        ...
        return (
          <li
            ...
            className={classnames(
              ...
              pageNumber === currentPage ? "px-3 py-2 text-blue-600 border border-gray-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white" : ""
            )}
